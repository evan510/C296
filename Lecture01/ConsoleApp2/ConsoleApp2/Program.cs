...
namespace ConsoleApp2
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			bool pokemonCanPowerUp = playerStardust >= pokemonPowerUpStardust && playerZapdosCandy >= pokemonPowerUpCandy;

			string pokemonInfomation = "寶可夢名稱：{0}\nHP：{1}/{2}";
			Console.WriteLine(pokemonInfomation, pokemonName, pokemonHp, pokemonMaxHp);
